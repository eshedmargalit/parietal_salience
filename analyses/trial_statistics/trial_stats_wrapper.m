function trial_stats_wrapper(datasets, mode, order)
% TRIAL_STATS_WRAPPER
% Inputs
...
%	None
	...
	case 'aggregate'
		...
		inactivation_left_stats = trial_stats(inactivation_trials,...
			'left',order,	'inactivation-left'); 
		inactivation_right_stats = trial_stats(inactivation_trials,...
			'right',order, 'inactivation-right'); 
